  ...
  return (
    <div className='flex flex-col md:flex-row bg-transparent justify-between mt-14 py-10 lg:gap-7 px-4 mx-4 md:mx-24'>
      ...
      <div className='flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-4'>
        ...
        <button className="flex items-center space-x-2 bg-transparent hover:bg-gray-600 border border-gray-700 text-white py-2 px-4 rounded-xl transition duration-300">
